...
@api_bp.route("/documents/<filename>")
...
# 注册视图
ImageUploadView.register_to_blueprint(api_bp, "/upload/image", endpoint="upload_image")
DocumentUploadView.register_to_blueprint(api_bp, "/upload/document", endpoint="upload_document")
