...
# 创建 MethodView 类
class I18nDemoView(OpenAPIMethodViewMixin, MethodView):
    @openapi_metadata(
        summary=I18nStr({
...
class ItemI18nView(OpenAPIMethodViewMixin, MethodView):
    @openapi_metadata(
        summary=I18nStr({
...
# 注册视图
I18nDemoView.register_to_blueprint(api_bp, "/welcome", endpoint="welcome")
ItemI18nView.register_to_blueprint(api_bp, "/items", endpoint="items_collection")
ItemI18nView.register_to_blueprint(api_bp, "/items/<string:x_request_path_item_id>", endpoint="item")
